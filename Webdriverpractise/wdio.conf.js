...
export const config = {
    ...
    //
    specs: [
     //   './test/specs/CreatePuechaseOrderAndStore.js'
      //  `./test/specs/${global.wdioEnvParameters.config.appNamespec}.js`
        './test/specs/DisplaySalesOrder.js'
       //'./test/specs/CreatePurchaseOrderUsingToken.js'
       // './test/specs/SalesOrderCreationDisplay.js'
      // './test/specs/SalesOrderCreation.js'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    // "C:\Users\RY214ZU\Downloads\edgedriver_win64\msedgedriver.exe"
   // path: '/C:/Users/RY214ZU/Downloads/edgedriver_win64/msedgedriver.exe', 
