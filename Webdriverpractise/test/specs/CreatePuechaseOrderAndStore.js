  ...
  try {
    const response = await axios.get(url, {
      ...
      headers: {
        "X-CSRF-Token": "fetch",
        //"Authorization": "••••••",
        "Cookie": "SAP_SESSIONID_FO4_100=vpoxzw76u3Ujp-UOyaUqA3EU70VsNBHvguidleiXvqQ%3d; SAP_SESSIONID_FO4_200=gmr9ukKeytcN0J7UEOtBJO8w2Gtw1hHvj_KdleiXvqQ%3d; sap-usercontext=sap-client=200"
      },
      httpsAgent: agent,
